 ...
 * -------------------------------------
 * A lightweight, open-source font inspector — CSP-safe and powered by Shadow DOM UI.
 *
 * Usage:
 * - Click the extension icon to enable "pick mode".
 * - Click any visible text → font details popup will appear near cursor.
 ...
 * https://github.com/wahibirawan/fontseek
 *
 * (c) 2025 Wahib Irawan — Open source under the MIT License.
 */
  ...
  const onClick = (e) => {
    ...
    (() => {
      ...
      btn.addEventListener("click", (ev) => {
        ...
        window.open(
          `https://www.bing.com/search?q=${encodeURIComponent(q + " font")}`,
          "_blank",
          "noopener"
        );
      });
